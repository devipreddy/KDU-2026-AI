...
def lookup_phi_value_for_user(
    ...
    *,
    ...
    if user_requires_patient_assignment_for_phi(current_user) and not patient_is_assigned_to_user(
        db,
        current_user,
        ...
        record_phi_lookup_audit(
            ...
            token=normalized_token,
            decision="deny",
            reason="patient_assignment_required",
        )
        db.commit()
        raise PhiLookupDeniedError("PHI lookup is not permitted for this user")
